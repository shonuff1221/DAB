...
contract StratX is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isDABComp; // this vault is purely for staking. eg. WBNB-DAB staking vault.
    ...
    address public DABFarmAddress;
    address public DABAddress;
    ...
    address[] public earnedToDABPath;
    ...
    constructor(
        ...
        DABFarmAddress = _DABFarmAddress;
        DABAddress = _DABAddress;

        isCAKEStaking = _isCAKEStaking;
        isDABComp = _isDABComp;
        ...
        if (isDABComp) {
            ...
            earnedToDABPath = [earnedAddress, wbnbAddress, DABAddress];
            if (wbnbAddress == earnedAddress) {
                earnedToDABPath = [wbnbAddress, DABAddress];
            }
        ...
        transferOwnership(DABFarmAddress);
    }
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(DABFarmAddress, _wantAmt);

...
contract StratVLEV is Ownable, ReentrancyGuard, Pausable {
    ...
    constructor(
        ...
        earnedToDABPath = [venusAddress, wbnbAddress, DABAddress];
    ...
    function buyBack(uint256 _earnedAmt) internal returns (uint256) {
        ...
        // Burn DAB tokens
        uint256 burnAmt = IERC20(DABAddress).balanceOf(address(this));
        IERC20(DABAddress).safeTransfer(buyBackAddress, burnAmt);

...
/**
 * @dev DABFarm functions that do not require less than the min timelock
 */
interface IDABFarm {
    function add(
        uint256 _allocPoint,
...
contract TimelockController is AccessControl {
    ...
    function executeSet(
        ...
        _beforeCall(predecessor);
        IDABFarm(_DABfarmAddress).set(_pid, _allocPoint, _withUpdate);
        _afterCall(id);
    }
    ...
    function add(
        ...
        IDABFarm(_DABfarmAddress).add(0, _want, _withUpdate, _strat); // allocPoint = 0. Schedule set (timelocked) to increase allocPoint.
    }
